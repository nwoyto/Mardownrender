...
## 3. Personalized Hook Template System
...
This should be generated dynamically by an LLM before upload into Instantly.

The hook should be **one short sentence**, ideally 6–14 words. It should prove minimal relevance without making the email feel over-personalized or creepy.
...
```text
Observed relevance + company/audience context + COVID-era operating period
```

The hook should not mention refunds, penalties, IRS claims, Kwong, or eligibility. Those belong in the locked email template.
...
Use these for business owners, operators, CFOs, controllers, and finance contacts.

#### Industry-Based Hook

```text
I was looking at {{industry}} businesses that operated through the COVID period.
```

Example:

```text
I was looking at restaurant groups that operated through the COVID period.
```

#### Company-Active Hook

```text
Looks like {{company_name}} was active during the 2020–2023 window.
```

Example:

```text
Looks like Apex Mechanical was active during the 2020–2023 window.
```

#### Location-Based Hook

```text
I was reviewing {{state}} businesses that were active during the pandemic.
```

Example:

```text
I was reviewing Pennsylvania businesses that were active during the pandemic.
```

#### Role-Based Hook

```text
Noticed you handle finance-related matters for {{company_name}}.
```

Example:

```text
Noticed you handle finance-related matters for Apex Mechanical.
```

#### Owner / Executive Hook

```text
Looks like you are close to the operating side of {{company_name}}.
```

Example:

```text
Looks like you are close to the operating side of Apex Mechanical.
```

#### PPP-Signal Hook

Use only if you are comfortable referencing PPP indirectly.

```text
I was reviewing businesses that had COVID-era financing or operating disruption.
```
...
That feels too surveillance-heavy.
...
Use these for CPAs, tax preparers, enrolled agents, and accounting firms.

#### Small-Business Client Hook

```text
Looks like your firm works with business clients where this may be relevant.
```

#### Tax-Focused Hook

```text
I was looking at tax firms that support small-business clients.
```

#### Local CPA Hook

```text
I was reviewing accounting firms serving businesses in {{state}}.
```

#### Role-Based CPA Hook

```text
Noticed your role is tied closely to client tax planning.
```

#### Partner / Principal Hook

```text
Looks like you are involved in client advisory work at the firm.
```

#### Fallback CPA Hook

```text
I was looking for firms that work with business tax clients.
```

---

### Recover Tax Hook Templates

Use these when the sender is Recover Tax and the message introduces the collaboration with PenaltyBack.

#### Neutral Business Hook

```text
Looks like {{company_name}} was operating during the COVID tax period.
```

#### Advisory Hook

```text
I was reviewing businesses that may need a second look at COVID-era tax issues.
```

#### CPA Partnership Hook

```text
Looks like your firm may advise clients affected by COVID-era tax issues.
```

#### Fallback Recover Tax Hook

```text
I thought this may be worth putting on your radar.
```
...
```text
I was looking at {{industry}} businesses that operated through COVID.
```

```text
Looks like your firm works with small-business tax clients.
```

Bad hooks:

```text
I saw your PPP loan for $238,400.
```

```text
You may have overpaid the IRS.
```

```text
Your business probably qualifies for a refund.
```

```text
I noticed your company struggled during COVID.
```

The hook should create relevance, not make a claim.
...
It feels automated and cheapens the offer.

Use a natural micro-CTA instead. The goal is to get a simple reply without forcing a meeting or a link click too early.
...
```text
Should I send the quick checklist?
```

```text
Want me to send the 4-question screen?
```

```text
Worth checking for {{company_name}}?
```

```text
Should I close this out, or send the checklist?
```

For meeting-driven tests:
...
```text
Open to a quick screen, or should I send the checklist instead?
```

Preferred first-touch CTA:

```text
If this sounds relevant, I can send over the quick qualification checklist.

Worth sending?
```

Preferred meeting CTA:

```text
If useful, I can ask a few quick questions and tell you whether this is even worth reviewing.
